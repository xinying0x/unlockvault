        ...
        <div className="min-h-screen bg-gradient-to-br from-[#18122B] via-[#2D1B5A] to-[#1A1A2E]">
          ...
          {showScroll && (
            <button
              ...
              className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-white p-3 sm:p-4 rounded-full shadow-2xl transition-all duration-300 transform hover:scale-110 hover:shadow-purple-500/25"
          ...
          <main className="relative">
            <Head>
              <title>UnlockVault - Unlock Premium Tools, Apps & AI for Free</title>
              <meta name="description" content="UnlockVault gives you free and safe access to the best game hacks, premium apps, and AI tools. Discover the latest now!" />
              <meta property="og:title" content="UnlockVault - Unlock Premium Tools, Apps & AI for Free" />
              <meta property="og:description" content="UnlockVault gives you free and safe access to the best game hacks, premium apps, and AI tools. Discover the latest now!" />
