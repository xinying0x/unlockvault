...
const SearchPage: React.FC<SearchPageProps> = ({ 
  ...
  const renderSearchResult = (result: SearchResult, index: number) => {
    if (result.type === 'offer') {
      ...
      return (
        <div key={`offer-${offer.id}-${index}`} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-shadow duration-300">
      ...
      return (
        <div key={`article-${article.id}-${index}`} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden group hover:shadow-lg transition-shadow duration-300">
          <Link href={articleHref} className="block h-full">
            ...
            <div className="p-4">
              <h3 className="font-bold text-lg mb-2 text-gray-900 dark:text-white group-hover:text-green-600 dark:group-hover:text-green-400 transition-colors">
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="relative max-w-2xl mx-auto">
              <input
                ...
                className="w-full px-4 py-3 pl-12 pr-4 text-lg border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
              />
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              {(query || selectedCategory !== 'all' || selectedType !== 'all' || sortBy !== 'relevance') && (
                <button
                  ...
                  className="px-4 py-2 text-sm text-red-600 dark:text-red-400 hover:text-red-800 dark:hover:text-red-300 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-md transition-colors"
                >
                  Clear All
                </button>
              )}
          ...
          <div className="mb-6 text-sm text-gray-600 dark:text-gray-400">
            {query && (
              <p>
                Showing {searchStats.filtered} results for <strong className="text-gray-900 dark:text-white">"{query}"</strong>
